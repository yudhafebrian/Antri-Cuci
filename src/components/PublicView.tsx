...
export default function PublicView({ queue }: Props) {
  ...
  const displayOrder: Stage[] = tab === 'regular'
  ...
  return (
    <div>
      ...
      <div className="px-4 pt-3 pb-6">
        ...
        <div className="bg-[#F5F5F0] border border-dashed border-[#CCC] rounded-xl p-4 text-center mt-4">
          <div className="text-xs text-[#888]">Bagikan link ini ke pelanggan:</div>
          <div className="text-xs bg-white border border-[#EAEAE6] rounded-lg px-3 py-2 text-[#185FA5] mt-2 font-mono">fipautoshop.app/antrian</div>
          <div className="text-[11px] text-[#bbb] mt-2">Bisa dibuka tanpa login dari HP manapun</div>
        </div>
      </div>
    </div>
  );
